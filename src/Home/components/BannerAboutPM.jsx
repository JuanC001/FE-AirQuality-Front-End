...
En general, la exposición a estas partículas representa un alto riesgo de salubridad “debido a que pueden llegar a la profundidad de los pulmones, y algunas hasta pueden alcanzar el torrente sanguíneo”. Múltiples estudios científicos vincularon la exposición a la contaminación por partículas a una variedad de problemas de salud, entre otros: irritación en las vías respiratorias, tos o dificultad para respirar, asma agravada y/o función pulmonar reducida, infartos de miocardio (no mortales) y latidos irregulares, e incluso, muerte prematura en personas con enfermedades pulmonares o cardíacas. `,
}
                ...
                <Grid item minHeight={'70vh'} xs={12} md={6} p={1}>
                    ...
                    <Grid container height={'100%'} gap={1}>
                        ...
                        <Grid item height={'50%'} xs={12}>
                            ...
                            <Box minHeight={'20vh'} component={Paper} p={2} borderRadius={'20px'} display={'flex'}>
