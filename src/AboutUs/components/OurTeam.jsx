...
export const OurTeam = () => {
    ...
    const color1 = theme.palette.secondary.light
        ...
        <>
            ...
            <Box bgcolor={color1} minHeight={'50vh'} width={'100%'} pb={20} justifyContent={'center'} >
                ...
                <Box width={'80%'} mx={'auto'} mb={3}>
                    <Typography variant="h4" color="primary.main" textAlign={'center'} mb={2}><strong>Directores</strong></Typography>
                    <Divider variant='middle' />
                </Box>
                ...
                <Box width={'80%'} mx={'auto'} mb={3} mt={8}>
                    <Typography variant="h4" color="primary.main" textAlign={'center'} mb={2}><strong>Desarrolladores</strong></Typography>
                    <Divider variant='middle' />
                </Box>
                ...
                <Box width={'80%'} mx={'auto'} mb={3} mt={8}>
                    <Typography variant="h4" color="primary.main" textAlign={'center'} mb={2}><strong>Colaboradores</strong></Typography>
                    <Divider variant='middle' />
                </Box>
